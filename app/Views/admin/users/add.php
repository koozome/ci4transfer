  ...
  <div class="card-body">
    <form method="post" action="<?= site_url('admin/users/add') ?>">
      ...
      <div class="mb-3">
        ...
        <input type="email" name="email" class="form-control <?= isset($validation) && $validation->hasError('email') ? 'is-invalid' : '' ?>" value="<?= esc(old('email')) ?>">
      ...
      <div class="mb-3">
        ...
        <select name="group" class="form-select <?= isset($validation) && $validation->hasError('group') ? 'is-invalid' : '' ?>">
          ...
          <option value="administrator" <?= old('group') === 'administrator' ? 'selected' : '' ?>>administrator</option>
        </select>
